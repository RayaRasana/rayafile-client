#ifndef RAYAFILE_APPLET_H
#define RAYAFILE_APPLET_H
...
/**
 * The central class of rayafile client
 */
class RayaFileApplet : public QObject {
    Q_OBJECT
...
public:
    ...
    // Create a unique device id to replace obsolete ccnet id
...
/**
 * The global RayaFileApplet object
 */
extern RayaFileApplet *rayafileApp;

#define STR(s)     #s
#define STRINGIZE(x) STR(x)

#endif // RAYAFILE_APPLET_H